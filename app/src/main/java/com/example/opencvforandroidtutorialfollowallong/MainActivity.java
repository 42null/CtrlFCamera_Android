...
public class MainActivity extends CameraActivity {
    ...
    public static String LOG_TAG = "OpenCV_Log";
...
//                Core.rotate(input_gray, input_gray, Core.ROTATE_180);
//            } else if (rotation == Surface.ROTATION_180) {
//                Core.rotate(input_gray, input_gray, Core.ROTATE_90_COUNTERCLOCKWISE);
//            }
            return input_gray;
        }
    };
